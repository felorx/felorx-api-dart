...
class SubscriptionApi {
  ...
  Future<Response<String>> alipayNotify({ 
...
_responseData = rawData == null ? null : deserialize<SubscriptionDto, SubscriptionDto>(rawData, 'SubscriptionDto', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateAlipayOrderResultDto>> createAlipayOrder({ 
...
_responseData = rawData == null ? null : deserialize<CreatePayPalOrderResultDto, CreatePayPalOrderResultDto>(rawData, 'CreatePayPalOrderResultDto', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<AppPlanPriceDto>>> getPlanPrices({ 
...
_responseData = rawData == null ? null : deserialize<List<SubscriptionDto>, SubscriptionDto>(rawData, 'List<SubscriptionDto>', growable: true);
    ...
    return Response<List<SubscriptionDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> payPalReturn({ 
    String? token,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (subscriptionId != null) r'subscription_id': subscriptionId,
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PayPalWebhookProcessResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PayPalWebhookProcessResultDto>> payPalWebhook({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<VerifyReceiptResult, VerifyReceiptResult>(rawData, 'VerifyReceiptResult', growable: true);
    ...
    return Response<VerifyReceiptResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

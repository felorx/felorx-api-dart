...
class AiChatApi {
  ...
  Future<Response<AiChatCompletionDto>> createCompletion({ 
    CreateAiChatCompletionDto? createAiChatCompletionDto,
    ...
    final _path = r'/api/ai/chat/completions';
    ...
    try {
_bodyData=jsonEncode(createAiChatCompletionDto);
...
_responseData = rawData == null ? null : deserialize<AiChatCompletionDto, AiChatCompletionDto>(rawData, 'AiChatCompletionDto', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AiChatCompletionDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AiChatCompletionDto>> createCompletion_1({ 
    CreateAiChatCompletionDto? createAiChatCompletionDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/app/ai-chat/completion';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,

...
class CreditApi {
  ...
  Future<Response<CreateCreditAlipayOrderResultDto>> createAlipayOrder({
...
_responseData = rawData == null ? null : deserialize<CreateCreditAlipayOrderResultDto, CreateCreditAlipayOrderResultDto>(rawData, 'CreateCreditAlipayOrderResultDto', growable: true);
    ...
    return Response<CreateCreditAlipayOrderResultDto>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateCreditPayPalOrderResultDto>> createPayPalOrder({
...
_responseData = rawData == null ? null : deserialize<CreateCreditPayPalOrderResultDto, CreateCreditPayPalOrderResultDto>(rawData, 'CreateCreditPayPalOrderResultDto', growable: true);
    ...
    return Response<CreateCreditPayPalOrderResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreditAccountDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreditAccountDto>> creditGetAccount({
...
_responseData = rawData == null ? null : deserialize<CreditAccountDto, CreditAccountDto>(rawData, 'CreditAccountDto', growable: true);
    ...
    return Response<CreditAccountDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<CreditPackageDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<CreditPackageDto>>> getPackages({
    required String appId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<List<CreditPackageDto>, CreditPackageDto>(rawData, 'List<CreditPackageDto>', growable: true);
    ...
    return Response<List<CreditPackageDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdjustCreditsResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdjustCreditsResultDto>> refund({
...
_responseData = rawData == null ? null : deserialize<AdjustCreditsResultDto, AdjustCreditsResultDto>(rawData, 'AdjustCreditsResultDto', growable: true);
    ...
    return Response<AdjustCreditsResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [AdjustCreditsResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdjustCreditsResultDto>> spend({
    AdjustCreditsDto? adjustCreditsDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,

...
// tests for BuildRecordDto
void main() {
  final BuildRecordDto? instance = /* BuildRecordDto(...) */ null;
  // TODO add properties to the entity

  group(BuildRecordDto, () {
    // String id
    ...
    // 构建产物下载地址
    // String artifactUrl
    test('to test the property `artifactUrl`', () async {
      // TODO
    });

    // 构建产物大小 (字节)
    // int artifactSize
    test('to test the property `artifactSize`', () async {
      // TODO
    });
    ...
    // CI/CD 构建ID
    // String ciBuildId
    test('to test the property `ciBuildId`', () async {
      // TODO
    });

...
// tests for AppRunRecordUpdateDto
void main() {
  final AppRunRecordUpdateDto? instance = /* AppRunRecordUpdateDto(...) */ null;
  // TODO add properties to the entity

  group(AppRunRecordUpdateDto, () {
    // String id
    ...
    // DateTime finishAt
    test('to test the property `finishAt`', () async {
      // TODO
    });

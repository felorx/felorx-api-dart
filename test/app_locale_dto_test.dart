...
// tests for AppLocaleDto
void main() {
  final AppLocaleDto? instance = /* AppLocaleDto(...) */ null;
  ...
  group(AppLocaleDto, () {
    ...
    // String fullDesc
    test('to test the property `fullDesc`', () async {
      // TODO
    });
    ...
    // String promoText
    test('to test the property `promoText`', () async {
      // TODO
    });
    ...
    // String privacyUrl
    test('to test the property `privacyUrl`', () async {
      // TODO
    });

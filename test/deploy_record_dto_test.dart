...
// tests for DeployRecordDto
void main() {
  final DeployRecordDto? instance = /* DeployRecordDto(...) */ null;
  // TODO add properties to the entity

  group(DeployRecordDto, () {
    // String id
    ...
    test('to test the property `buildRecordVersion`', () async {
      // TODO
    });
    ...
    // 部署地址
    // String deployUrl
    test('to test the property `deployUrl`', () async {
      // TODO
    });

    // 部署目标
    // String deployTarget
    test('to test the property `deployTarget`', () async {
      // TODO
    });

    // 部署渠道
    // String deployChannel
    test('to test the property `deployChannel`', () async {
      // TODO
    });
    ...
    // CI/CD 部署ID
    // String ciDeployId
    test('to test the property `ciDeployId`', () async {
      // TODO
    });

    // CI/CD 部署URL
    // String ciDeployUrl
    test('to test the property `ciDeployUrl`', () async {
      // TODO
    });
